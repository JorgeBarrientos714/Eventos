...
export default function Referencias({ value, onChange, onNext, onBack }: Props) {
  return (
    <div className="space-y-4">
      <h2 className="text-sm font-semibold text-ink-700">Referencias</h2>

      <div className="space-y-3 rounded-lg border border-brand-50 bg-base-50 p-4">
        <h3 className="text-xs font-semibold text-ink-700 uppercase">Familiar</h3>
      ...
      <div className="space-y-3 rounded-lg border border-brand-50 bg-base-50 p-4">
        <h3 className="text-xs font-semibold text-ink-700 uppercase">Personal</h3>
        <div className="grid gap-3 md:grid-cols-3">
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-ink-700 mb-1">
              Nombre completo
