...
export default function Beneficiarios({ value, onNext, onBack }: Props) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-sm font-semibold text-gray-700">Beneficiarios</h2>
      ...
      <div className="space-y-3">
        {value.map((b, idx) => (
          <div
            key={idx}
            className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 border border-gray-100 rounded-lg p-3 bg-gray-50"
          >
            <div>
